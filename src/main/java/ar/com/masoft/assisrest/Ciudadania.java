...
public class Ciudadania implements java.io.Serializable, ConID {
    @Id
    @TableGenerator(name = "cdd",
            table = "numerador",
            pkColumnName = "tipo",
            valueColumnName = "numero",
            pkColumnValue = "CDD",
            allocationSize = 1, initialValue = 1)
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "cdd")
    @Basic(optional = false)
    @Column(name = "CDD_ID")
    private Integer id;
    @Basic(optional = false)
    @Column(name = "CDD_NOMBRE", length=80)
    private String nombre;
    @Basic(optional = true)
    @Column(name = "CDD_IDVIEJO")
