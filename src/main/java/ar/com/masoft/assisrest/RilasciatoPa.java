...
public class RilasciatoPa implements java.io.Serializable,ConID {
    @Id
    @TableGenerator(name = "rip",
            table = "numerador",
            pkColumnName = "tipo",
            valueColumnName = "numero",
            pkColumnValue = "RIP",
            allocationSize = 1, initialValue = 1)
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "rip")
    @Basic(optional = false)
    @Column(name = "RIP_ID")
    private Integer id;
    @Basic(optional = false)
    @Column(name = "RIP_NOMBRE", length=80)
    private String nombre;
    @Column(name = "RIP_IDVIEJO")
