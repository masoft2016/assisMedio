...
public class Region implements java.io.Serializable,ConID {
    @Id
    @TableGenerator(name = "reg",
            table = "numerador",
            pkColumnName = "tipo",
            valueColumnName = "numero",
            pkColumnValue = "REG",
            allocationSize = 1, initialValue = 1)
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "reg")
    @Basic(optional = false)
    @Column(name = "REG_ID")
    private Integer id;
    @Basic(optional = false)
    @Column(name = "REG_NOMBRE", length=80)
    private String nombre;
    @Column(name = "REG_IDVIEJO")
