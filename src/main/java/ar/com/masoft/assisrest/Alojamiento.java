...
public class Alojamiento implements java.io.Serializable, ConID{
    @Id
    @TableGenerator(name = "alo",
            table = "numerador",
            pkColumnName = "tipo",
            valueColumnName = "numero",
            pkColumnValue = "ALO",
            allocationSize = 1, initialValue = 1)
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "alo")
